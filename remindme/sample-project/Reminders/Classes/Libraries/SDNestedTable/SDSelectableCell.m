...
//    checkBox.alpha = 1.0;
    itemText.alpha = 1.0;
    self.backgroundView.backgroundColor =[UIColor colorWithRed:8.0/255 green:28.0/255 blue:47.0/255 alpha:1.0];
    //UIColorFromRGBWithAlpha(0x081c2f, 1.0);
}
...
//    [checkBox addSubview:onCheckBox];
    checkBox.alpha = 0.45;
    itemText.alpha = 1.0;
    self.backgroundView.backgroundColor = [UIColor colorWithRed:5.0/255 green:18.0/255 blue:31.0/255 alpha:1.0];
    //UIColorFromRGBWithAlpha(0x05121f, 1.0);
}
